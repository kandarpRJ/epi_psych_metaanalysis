...
ha = HeatmapAnnotation(df = data[,2:4], 
                       col = list(Sex=c("F"="green", "M"="yellow", "Mix"="orange")))
...
png("MDD_heatmap_with_biorxiv.png", res = 600, width = 5000, height = 5000)
...
png("PTSD_heatmap_with_biorxiv.png", res = 600, width = 5000, height = 5000)
draw(h, heatmap_legend_side="bottom")
dev.off()
